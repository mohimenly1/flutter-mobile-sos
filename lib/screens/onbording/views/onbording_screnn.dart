...
class _OnBordingScreenState extends State<OnBordingScreen> {
  ...
  final List<Onbord> _onbordData = [
    ...
    Onbord(
      image: "assets/Illustration/Illustration-1.jpg",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_1.png",
      title: "قبل إقامة أيّ مشروع يجب أن نراعي البيئة \nوحق الأجيال القادمة",
      description: "",
    ),
    Onbord(
      image: "assets/Illustration/Illustration-2.jpg",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_2.png",
      title: "Fast & secure \npayment",
      description: "There are many payment options available for your ease.",
    ),
    Onbord(
      image: "assets/Illustration/Illustration-3.jpg",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_3.png",
      title: "إماطة الأذى عن الطريق صدقة",
      description: "فالمكان سر العنوان، فدع نظافتك عنوانك",
    ),
    Onbord(
